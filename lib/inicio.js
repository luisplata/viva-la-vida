/* 
 * Problema:
 * - colocar el evento cuando los dialogos se acaben para asic ambiar de estado
 * - en un textfild no sale el mouse.input
 * 
 */
...
//variables
    ...
    this.dialogo = new Kiwi.GameObjects.Textfield(this, "Click aqui para comenzar", 50, 50, "#000", 17, 'normal', 'Impact');
    ;
    //timer
...
// Demo rectangles
    ...
    //this.game.input.mouse.onUp.add(this.clicked, this.rectangleStroke);
    //this.game.input.mouse.onDown.add(this.startTimer, this);
    this.game.input.onDown.add(this.startTimer, this);
    ...
    //creando eventos de los objetos añaddos
    this.rectangleStroke.input.onDown.add(this.cambio, this);

};

state.cambio = function () {
    //cambiar de estado

    console.log("Intendando cambiar de estado");
